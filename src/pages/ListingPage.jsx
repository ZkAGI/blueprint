  ...
  if (loading) {
    return (
      <div className="relative min-h-screen text-white flex items-center justify-center">
        <StarfieldBackground /> {/* ★ galaxy during loading too */}
        <div className="relative z-10 text-white/80 text-xl">Loading listings…</div>
      </div>
    );
  }

  return (
    // Root: starfield behind EVERYTHING; content is on top
    <div className="relative min-h-screen text-white flex flex-col bg-transparent">
      <StarfieldBackground /> {/* ★ fixed, full-page background */}
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Footer pinned to bottom */}
        <footer className="mt-auto w-full border-t border-cyan-400/40 bg-transparent">
          <div className="mx-auto max-w-screen-2xl px-4 py-6 pb-[env(safe-area-inset-bottom)]">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
